...
public class WordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
	    ...
	    private String pattern= "^/(?!(the|and|but)([a-z][a-z0-9]*)$";
	    
	    //LIO_EDIT:
	    // One way to exclude certain words like "the" or "and"
	    //private String pattern = "^/(?!the|and|but)([a-z0-9]*)$"
	    ...
	    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
	        ...
	        while (tokenizer.hasMoreTokens()) {
	            ...
	            //LIO_EDIT:
	           // This if statement checks that the word isnt a stop word
	            if(!stringWord.equals("the") && !stringWord.equals("and")){
